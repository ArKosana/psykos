// List of 4-letter words for room codes
export const WORD_LIST = [
    ...
    'COOK', 'COOL', 'COPE', 'COPY', 'CORE', 'COST', 'CREW', 'CROP', 'CURE', 'CUTE',
    ...
    'JURY', 'JUST', 'KEEP', 'KENT', 'KEpt', 'KICK', 'KILL', 'KIND', 'KING', 'KNEW',
    ...
    'MYTH', 'NAIL', 'NAME', 'NAVY', 'NEAR', 'NECK', 'NEED', 'NEWS', 'NEXT', 'NICE',
    ...
    'SHOW', 'SHUT', 'SICK', 'SIDE', 'SIGN', 'SITE', 'SIZE', 'SKIN', 'SLOW', 'SNOW',
    ...
    'TRAP', 'TREE', 'TRIP', 'TRUE', 'TUNE', 'TURN', 'TWIN', 'TYPE', 'UNIT', 'UPON',
    'USED', 'USER', 'VARY', 'VERY', 'VICE', 'VIEW', 'VOTE', 'WAGE', 'WAIT', 'WAKE',
